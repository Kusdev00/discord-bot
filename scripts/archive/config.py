...
class Config:
    ...
    WELCOME_LOG_CHANNEL_ID: Optional[int] = _parse_int(os.getenv("WELCOME_LOG_CHANNEL_ID"))

    # Data paths
    DATA_DIR: Path = PROJECT_ROOT / "data"
    WELCOME_MESSAGES_FILE: Path = DATA_DIR / "welcome_messages.json"
    WELCOME_IMAGES_FILE: Path = DATA_DIR / "welcome_images.json"
    WELCOME_CONFIG_FILE: Path = DATA_DIR / "welcome_config.json"

    # Logging
    LOG_LEVEL: str = os.getenv("LOG_LEVEL", "INFO")
    LOG_FILE: Optional[Path] = _parse_path(os.getenv("LOG_FILE"))
